...
@section('title', 'Edit Employee - NepByte Admin')
            ...
            <div>
                ...
                <div class="mt-4">
                    ...
                    <textarea name="address" id="address" rows="3"
                              class="w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('address') border-red-500 @enderror">{{ old('address', $employee->address) }}</textarea>
                    @error('address')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div>
                ...
                <div class="mt-4">
                    ...
                    <textarea name="skills" id="skills" rows="3" placeholder="List employee skills and competencies"
                              class="w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('skills') border-red-500 @enderror">{{ old('skills', $employee->skills) }}</textarea>
                    @error('skills')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
