...
@section('title', 'Add Client - NepByte Admin')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="client_type" id="client_type" required
                            ...
                            <option value="small_business" {{ old('client_type') == 'small_business' ? 'selected' : '' }}>Small Business</option>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="number" name="total_contract_value" id="total_contract_value" value="{{ old('total_contract_value') }}" step="0.01" min="0"
                               placeholder="0.00"
